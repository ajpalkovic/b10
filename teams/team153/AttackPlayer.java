...
public abstract class AttackPlayer extends NovaPlayer {
    ...
    public void processEnemies() {
        ...
        ArrayList<RobotInfo> enemiesInfo = senseEnemyRobotInfoInSensorRange();
    ...
    public void returnToStartingLocation() {
        ...
        moveOnceTowardsLocation(startingLocation);
    }
    
    public void moveToAttack() {
        movingToAttack = true;
       if(outOfRangeEnemies.size() > 0)
           moveOnceTowardsLocation(getCheapestEnemy(outOfRangeEnemies).location);
       else
           moveOnceTowardsLocation(getCheapestEnemy(outOfRangeArchonEnemies).location);
...
public MapLocation findBestLocation(MapLocation location) { return null; }
/*
